  ...
  describe ConstRegistry do
    ...
    describe "#lookup" do
      context "without scope" do
        before do
          const_registry.add("A", nil, "test_file.rb", type: :class)
          const_registry.add("B", nil, "test_file.rb", type: :class)
          const_registry.add("B::A", nil, "test_file.rb", type: :class)
        end
      ...
      context "with scope" do
        before do
          const_registry.add("A", nil, "test_file.rb", type: :class)
          const_registry.add("A::B0", nil, "test_file.rb", type: :class)
          const_registry.add("A::B0::C", nil, "test_file.rb", type: :class)
          const_registry.add("A::B1", nil, "test_file.rb", type: :class)
          const_registry.add("B0", nil, "test_file.rb", type: :class)
          const_registry.add("B0::C", nil, "test_file.rb", type: :class)
        end
